...
var EnclosingClass = require('android.animation.LayoutTransition');
...
var TransitionListener = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'android.animation.LayoutTransition$TransitionListener') {
		result = arguments[0];
	}
	else {
		var instance = this,
		...
		subclass = Hyperloop.implement('android.animation.LayoutTransition$TransitionListener');
...
TransitionListener.className = "android.animation.LayoutTransition$TransitionListener";
TransitionListener.prototype.className = "android.animation.LayoutTransition$TransitionListener";

// class property
Object.defineProperty(TransitionListener, 'class', {
	get: function() {
		return Hyperloop.getClass('android.animation.LayoutTransition$TransitionListener');
	},
	enumerable: true,
	configurable: false
});
...
TransitionListener.cast = function(object) {
	...
	return new TransitionListener(Hyperloop.cast('android.animation.LayoutTransition$TransitionListener', object.$native));
};
