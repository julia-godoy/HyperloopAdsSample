...
var Editor = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'android.content.SharedPreferences$Editor') {
		...
		subclass = Hyperloop.implement('android.content.SharedPreferences$Editor');
...
Editor.isInstanceOf = function (self, cls) {
...
Editor.className = "android.content.SharedPreferences$Editor";
Editor.prototype.className = "android.content.SharedPreferences$Editor";

// class property
Object.defineProperty(Editor, 'class', {
	get: function() {
		return Hyperloop.getClass('android.content.SharedPreferences$Editor');
	},
	enumerable: true,
	configurable: false
});
...
// Cast
Editor.cast = function(object) {
	if (!object.$native || !object.$native.isInstanceProxy) return object;
	return new Editor(Hyperloop.cast('android.content.SharedPreferences$Editor', object.$native));
};

// Constants

Editor.prototype.equals = function (other) {
...
Editor.prototype.hashCode = function () {
	if (!this._hasPointer) return null;
