...
var Callback = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'android.graphics.drawable.Drawable$Callback') {
		...
		subclass = Hyperloop.implement('android.graphics.drawable.Drawable$Callback');
...
Callback.className = "android.graphics.drawable.Drawable$Callback";
Callback.prototype.className = "android.graphics.drawable.Drawable$Callback";

// class property
Object.defineProperty(Callback, 'class', {
	get: function() {
		return Hyperloop.getClass('android.graphics.drawable.Drawable$Callback');
	},
	enumerable: true,
	configurable: false
});
...
Callback.cast = function(object) {
	...
	return new Callback(Hyperloop.cast('android.graphics.drawable.Drawable$Callback', object.$native));
};
