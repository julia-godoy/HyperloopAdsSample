...
var MenuItem = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'android.view.MenuItem') {
		...
		subclass = Hyperloop.implement('android.view.MenuItem');
...
MenuItem.isInstanceOf = function (self, cls) {
...
MenuItem.className = "android.view.MenuItem";
MenuItem.prototype.className = "android.view.MenuItem";

// class property
Object.defineProperty(MenuItem, 'class', {
	get: function() {
		return Hyperloop.getClass('android.view.MenuItem');
	},
	enumerable: true,
	configurable: false
});
...
// Cast
MenuItem.cast = function(object) {
	if (!object.$native || !object.$native.isInstanceProxy) return object;
	return new MenuItem(Hyperloop.cast('android.view.MenuItem', object.$native));
};
...
MenuItem.SHOW_AS_ACTION_COLLAPSE_ACTION_VIEW = 8;
...
MenuItem.SHOW_AS_ACTION_WITH_TEXT = 4;
