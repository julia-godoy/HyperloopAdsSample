...
var SubMenu = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'android.view.SubMenu') {
		...
		subclass = Hyperloop.implement('android.view.SubMenu');
...
SubMenu.isInstanceOf = function (self, cls) {
...
SubMenu.className = "android.view.SubMenu";
SubMenu.prototype.className = "android.view.SubMenu";

// class property
Object.defineProperty(SubMenu, 'class', {
	get: function() {
		return Hyperloop.getClass('android.view.SubMenu');
	},
	enumerable: true,
	configurable: false
});
...
// Cast
SubMenu.cast = function(object) {
	if (!object.$native || !object.$native.isInstanceProxy) return object;
	return new SubMenu(Hyperloop.cast('android.view.SubMenu', object.$native));
};

// Constants

SubMenu.prototype.equals = function (other) {
...
SubMenu.prototype.hashCode = function () {
	if (!this._hasPointer) return null;
