...
var Callback = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'android.view.SurfaceHolder$Callback') {
		result = arguments[0];
	}
	else {
		var instance = this,
		...
		subclass = Hyperloop.implement('android.view.SurfaceHolder$Callback');
...
Callback.className = "android.view.SurfaceHolder$Callback";
Callback.prototype.className = "android.view.SurfaceHolder$Callback";

// class property
Object.defineProperty(Callback, 'class', {
	get: function() {
		return Hyperloop.getClass('android.view.SurfaceHolder$Callback');
	},
	enumerable: true,
	configurable: false
});
...
Callback.cast = function(object) {
	...
	return new Callback(Hyperloop.cast('android.view.SurfaceHolder$Callback', object.$native));
};
