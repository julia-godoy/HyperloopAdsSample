...
var LayoutParams = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].isInstanceProxy && arguments[0].isInstanceOf('android.widget.Toolbar$LayoutParams')) {
		result = arguments[0];
	}
	else {
...
LayoutParams.className = 'android.widget.Toolbar$LayoutParams';
LayoutParams.prototype.className = 'android.widget.Toolbar$LayoutParams';

// class property
Object.defineProperty(LayoutParams, 'class', {
	get: function() {
		return Hyperloop.getClass('android.widget.Toolbar$LayoutParams');
	},
	enumerable: true,
	configurable: false
});
...
LayoutParams.extend = function (overrides) {
	var subclassProxy = Hyperloop.extend('android.widget.Toolbar$LayoutParams');
...
LayoutParams.cast = function(object) {
	...
	return new LayoutParams(Hyperloop.cast('android.widget.Toolbar$LayoutParams', object.$native));
};
