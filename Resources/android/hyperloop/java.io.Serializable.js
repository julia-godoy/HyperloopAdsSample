...
var Serializable = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'java.io.Serializable') {
		result = arguments[0];
	}
	else {
		var instance = this,
		...
		subclass = Hyperloop.implement('java.io.Serializable');
...
Serializable.toString = function() {
...
Serializable.isInstanceOf = function (self, cls) {
...
Serializable.className = "java.io.Serializable";
Serializable.prototype.className = "java.io.Serializable";

// class property
Object.defineProperty(Serializable, 'class', {
	get: function() {
		return Hyperloop.getClass('java.io.Serializable');
	},
	enumerable: true,
	configurable: false
});
...
// Cast
Serializable.cast = function(object) {
	if (!object.$native || !object.$native.isInstanceProxy) return object;
	return new Serializable(Hyperloop.cast('java.io.Serializable', object.$native));
};
