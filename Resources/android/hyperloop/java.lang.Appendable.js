...
var Appendable = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'java.lang.Appendable') {
		result = arguments[0];
	}
	else {
		var instance = this,
		...
		subclass = Hyperloop.implement('java.lang.Appendable');
...
Appendable.toString = function() {
	return "[object " + this.className + "]";
};

Appendable.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
Appendable.isInstanceOf = function (self, cls) {
...
Appendable.className = "java.lang.Appendable";
Appendable.prototype.className = "java.lang.Appendable";

// class property
Object.defineProperty(Appendable, 'class', {
	get: function() {
		return Hyperloop.getClass('java.lang.Appendable');
	},
	enumerable: true,
	configurable: false
});
...
// Cast
Appendable.cast = function(object) {
	if (!object.$native || !object.$native.isInstanceProxy) return object;
	return new Appendable(Hyperloop.cast('java.lang.Appendable', object.$native));
};

// Constants

Appendable.prototype.equals = function (other) {
...
Appendable.prototype.hashCode = function () {
	if (!this._hasPointer) return null;
