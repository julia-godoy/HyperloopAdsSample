...
var Enum = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].isInstanceProxy && arguments[0].isInstanceOf('java.lang.Enum')) {
		result = arguments[0];
	}
	else {
...
Enum.prototype = Object.create(SuperClass.prototype);
Enum.prototype.constructor = Enum;

Object.defineProperty(Enum.prototype, 'super', {
	get: function() {
		if (!this._hasPointer) return null;
		return new Enum(this.$native.super);
	},
	enumerable: true
});

Enum.className = 'java.lang.Enum';
Enum.prototype.className = 'java.lang.Enum';

// class property
Object.defineProperty(Enum, 'class', {
	get: function() {
		return Hyperloop.getClass('java.lang.Enum');
	},
	enumerable: true,
	configurable: false
});
...
// Allow subclassing
Enum.extend = function (overrides) {
	var subclassProxy = Hyperloop.extend('java.lang.Enum');
	...
	SubClass.prototype = Object.create(Enum.prototype);
	SubClass.prototype.constructor = SubClass;
	return SubClass;
};

// Cast
Enum.cast = function(object) {
	if (!object.$native || !object.$native.isInstanceProxy) return object;
	return new Enum(Hyperloop.cast('java.lang.Enum', object.$native));
};
 ...
 **/
Enum.prototype.equals = function() {
	if (!this._hasPointer) return null;
 ...
 **/
Enum.prototype.compareTo = function() {
	if (!this._hasPointer) return null;
