...
var Iterable = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'java.lang.Iterable') {
		...
		subclass = Hyperloop.implement('java.lang.Iterable');
...
Iterable.isInstanceOf = function (self, cls) {
...
Iterable.className = "java.lang.Iterable";
Iterable.prototype.className = "java.lang.Iterable";

// class property
Object.defineProperty(Iterable, 'class', {
	get: function() {
		return Hyperloop.getClass('java.lang.Iterable');
	},
	enumerable: true,
	configurable: false
});
...
// Cast
Iterable.cast = function(object) {
	if (!object.$native || !object.$native.isInstanceProxy) return object;
	return new Iterable(Hyperloop.cast('java.lang.Iterable', object.$native));
};

// Constants

Iterable.prototype.equals = function (other) {
...
Iterable.prototype.hashCode = function () {
	if (!this._hasPointer) return null;
