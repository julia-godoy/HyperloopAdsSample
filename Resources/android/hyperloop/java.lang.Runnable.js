...
var Runnable = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'java.lang.Runnable') {
		...
		subclass = Hyperloop.implement('java.lang.Runnable');
...
Runnable.isInstanceOf = function (self, cls) {
...
Runnable.className = "java.lang.Runnable";
Runnable.prototype.className = "java.lang.Runnable";

// class property
Object.defineProperty(Runnable, 'class', {
	get: function() {
		return Hyperloop.getClass('java.lang.Runnable');
	},
	enumerable: true,
	configurable: false
});
...
// Cast
Runnable.cast = function(object) {
	if (!object.$native || !object.$native.isInstanceProxy) return object;
	return new Runnable(Hyperloop.cast('java.lang.Runnable', object.$native));
};

// Constants

Runnable.prototype.equals = function (other) {
...
Runnable.prototype.hashCode = function () {
	if (!this._hasPointer) return null;
