...
var Type = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'java.lang.reflect.Type') {
		result = arguments[0];
	}
	else {
		var instance = this,
		...
		subclass = Hyperloop.implement('java.lang.reflect.Type');
...
Type.isInstanceOf = function (self, cls) {
...
Type.className = "java.lang.reflect.Type";
Type.prototype.className = "java.lang.reflect.Type";

// class property
Object.defineProperty(Type, 'class', {
	get: function() {
		return Hyperloop.getClass('java.lang.reflect.Type');
	},
	enumerable: true,
	configurable: false
});
...
Type.cast = function(object) {
	...
	return new Type(Hyperloop.cast('java.lang.reflect.Type', object.$native));
};
