...
var ServerSocket = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].isInstanceProxy && arguments[0].isInstanceOf('java.net.ServerSocket')) {
		result = arguments[0];
	}
	else {
		result = ServerSocket.class.newInstance(arguments);
	}
...
ServerSocket.prototype = Object.create(SuperClass.prototype);
ServerSocket.prototype.constructor = ServerSocket;

Object.defineProperty(ServerSocket.prototype, 'super', {
	get: function() {
		if (!this._hasPointer) return null;
		return new ServerSocket(this.$native.super);
	},
	enumerable: true
});

ServerSocket.className = 'java.net.ServerSocket';
ServerSocket.prototype.className = 'java.net.ServerSocket';

// class property
Object.defineProperty(ServerSocket, 'class', {
	get: function() {
		return Hyperloop.getClass('java.net.ServerSocket');
	},
	enumerable: true,
	configurable: false
});
...
// Allow subclassing
ServerSocket.extend = function (overrides) {
	var subclassProxy = Hyperloop.extend('java.net.ServerSocket');
	...
	SubClass.prototype = Object.create(ServerSocket.prototype);
	SubClass.prototype.constructor = SubClass;
	return SubClass;
};

// Cast
ServerSocket.cast = function(object) {
	if (!object.$native || !object.$native.isInstanceProxy) return object;
	return new ServerSocket(Hyperloop.cast('java.net.ServerSocket', object.$native));
};
 ...
 **/
ServerSocket.setSocketFactory = function() {
	...
	if (result.apiName) {
		if (result.apiName === 'java.net.ServerSocket') {
			return new ServerSocket(result);
		} else {
 ...
 **/
ServerSocket.prototype.getInetAddress = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ServerSocket.prototype.getLocalPort = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ServerSocket.prototype.setReceiveBufferSize = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ServerSocket.prototype.getLocalSocketAddress = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ServerSocket.prototype.setReuseAddress = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ServerSocket.prototype.getReceiveBufferSize = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ServerSocket.prototype.getReuseAddress = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ServerSocket.prototype.setSoTimeout = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ServerSocket.prototype.accept = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ServerSocket.prototype.setPerformancePreferences = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ServerSocket.prototype.bind = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ServerSocket.prototype.isClosed = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ServerSocket.prototype.getChannel = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ServerSocket.prototype.isBound = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ServerSocket.prototype.getSoTimeout = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ServerSocket.prototype.toString = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ServerSocket.prototype.implAccept = function() {
	if (!this._hasPointer) return null;
