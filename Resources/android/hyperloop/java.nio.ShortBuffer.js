...
var ShortBuffer = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].isInstanceProxy && arguments[0].isInstanceOf('java.nio.ShortBuffer')) {
		result = arguments[0];
	}
	else {
...
ShortBuffer.prototype = Object.create(SuperClass.prototype);
ShortBuffer.prototype.constructor = ShortBuffer;

Object.defineProperty(ShortBuffer.prototype, 'super', {
	get: function() {
		if (!this._hasPointer) return null;
		return new ShortBuffer(this.$native.super);
	},
	enumerable: true
});

ShortBuffer.className = 'java.nio.ShortBuffer';
ShortBuffer.prototype.className = 'java.nio.ShortBuffer';

// class property
Object.defineProperty(ShortBuffer, 'class', {
	get: function() {
		return Hyperloop.getClass('java.nio.ShortBuffer');
	},
	enumerable: true,
	configurable: false
});
...
// Allow subclassing
ShortBuffer.extend = function (overrides) {
	var subclassProxy = Hyperloop.extend('java.nio.ShortBuffer');
	...
	SubClass.prototype = Object.create(ShortBuffer.prototype);
	SubClass.prototype.constructor = SubClass;
	return SubClass;
};

// Cast
ShortBuffer.cast = function(object) {
	if (!object.$native || !object.$native.isInstanceProxy) return object;
	return new ShortBuffer(Hyperloop.cast('java.nio.ShortBuffer', object.$native));
};
 ...
 **/
ShortBuffer.prototype.hasArray = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ShortBuffer.prototype.compact = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ShortBuffer.prototype.duplicate = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ShortBuffer.prototype.compareTo = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ShortBuffer.prototype.asReadOnlyBuffer = function() {
	if (!this._hasPointer) return null;
 ...
 * @see {@link http://developer.android.com/reference/java/nio/ShortBuffer.html#put(short[])}
 **/
ShortBuffer.prototype.put = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ShortBuffer.prototype.slice = function() {
	if (!this._hasPointer) return null;
 ...
 * @see {@link http://developer.android.com/reference/java/nio/ShortBuffer.html#array()}
 **/
ShortBuffer.prototype.array = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ShortBuffer.prototype.hashCode = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ShortBuffer.prototype.get = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ShortBuffer.prototype.equals = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ShortBuffer.prototype.arrayOffset = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ShortBuffer.prototype.toString = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ShortBuffer.prototype.isDirect = function() {
	if (!this._hasPointer) return null;
 ...
 **/
ShortBuffer.prototype.order = function() {
	if (!this._hasPointer) return null;
