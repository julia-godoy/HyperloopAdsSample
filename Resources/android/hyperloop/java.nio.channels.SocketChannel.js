...
var SocketChannel = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].isInstanceProxy && arguments[0].isInstanceOf('java.nio.channels.SocketChannel')) {
		result = arguments[0];
	}
	else {
...
SocketChannel.prototype = Object.create(SuperClass.prototype);
SocketChannel.prototype.constructor = SocketChannel;

Object.defineProperty(SocketChannel.prototype, 'super', {
	get: function() {
		if (!this._hasPointer) return null;
		return new SocketChannel(this.$native.super);
	},
	enumerable: true
});

SocketChannel.className = 'java.nio.channels.SocketChannel';
SocketChannel.prototype.className = 'java.nio.channels.SocketChannel';

// class property
Object.defineProperty(SocketChannel, 'class', {
	get: function() {
		return Hyperloop.getClass('java.nio.channels.SocketChannel');
	},
	enumerable: true,
	configurable: false
});
...
// Allow subclassing
SocketChannel.extend = function (overrides) {
	var subclassProxy = Hyperloop.extend('java.nio.channels.SocketChannel');
	...
	SubClass.prototype = Object.create(SocketChannel.prototype);
	SubClass.prototype.constructor = SubClass;
	return SubClass;
};

// Cast
SocketChannel.cast = function(object) {
	if (!object.$native || !object.$native.isInstanceProxy) return object;
	return new SocketChannel(Hyperloop.cast('java.nio.channels.SocketChannel', object.$native));
};
...
SocketChannel.open = function() {
	...
	if (result.apiName) {
		if (result.apiName === 'java.nio.channels.SocketChannel') {
			return new SocketChannel(result);
		} else {
 ...
 * @see {@link http://developer.android.com/reference/java/nio/channels/SocketChannel.html#setOption(java.net.SocketOption, java.lang.Object)}
 **/
SocketChannel.prototype.setOption = function() {
	if (!this._hasPointer) return null;
 ...
 **/
SocketChannel.prototype.isConnectionPending = function() {
	if (!this._hasPointer) return null;
 ...
 * @see {@link http://developer.android.com/reference/java/nio/channels/SocketChannel.html#read(java.nio.ByteBuffer[])}
 **/
SocketChannel.prototype.read = function() {
	if (!this._hasPointer) return null;
 ...
 **/
SocketChannel.prototype.isConnected = function() {
	if (!this._hasPointer) return null;
 ...
 **/
SocketChannel.prototype.getRemoteAddress = function() {
	if (!this._hasPointer) return null;
 ...
 **/
SocketChannel.prototype.finishConnect = function() {
	if (!this._hasPointer) return null;
 ...
 **/
SocketChannel.prototype.shutdownOutput = function() {
	if (!this._hasPointer) return null;
 ...
 **/
SocketChannel.prototype.getLocalAddress = function() {
	if (!this._hasPointer) return null;
 ...
 **/
SocketChannel.prototype.shutdownInput = function() {
	if (!this._hasPointer) return null;
 ...
 * @see {@link http://developer.android.com/reference/java/nio/channels/SocketChannel.html#bind(java.net.SocketAddress)}
 **/
SocketChannel.prototype.bind = function() {
	if (!this._hasPointer) return null;
 ...
 **/
SocketChannel.prototype.socket = function() {
	if (!this._hasPointer) return null;
 ...
 * @see {@link http://developer.android.com/reference/java/nio/channels/SocketChannel.html#write(java.nio.ByteBuffer[])}
 **/
SocketChannel.prototype.write = function() {
	if (!this._hasPointer) return null;
 ...
 **/
SocketChannel.prototype.validOps = function() {
	if (!this._hasPointer) return null;
