...
/**
 * constructor
 * http://developer.android.com/reference/java/nio/file/Path.html
 **/
var Path = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'java.nio.file.Path') {
		result = arguments[0];
	}
	else {
		var instance = this,
		...
		subclass = Hyperloop.implement('java.nio.file.Path');
...
Path.isInstanceOf = function (self, cls) {
...
Path.className = "java.nio.file.Path";
Path.prototype.className = "java.nio.file.Path";

// class property
Object.defineProperty(Path, 'class', {
	get: function() {
		return Hyperloop.getClass('java.nio.file.Path');
	},
	enumerable: true,
	configurable: false
});
...
Path.cast = function(object) {
	...
	return new Path(Hyperloop.cast('java.nio.file.Path', object.$native));
};
