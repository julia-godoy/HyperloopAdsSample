...
var Collection = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'java.util.Collection') {
		result = arguments[0];
	}
	else {
		var instance = this,
		...
		subclass = Hyperloop.implement('java.util.Collection');
...
Collection.isInstanceOf = function (self, cls) {
...
Collection.className = "java.util.Collection";
Collection.prototype.className = "java.util.Collection";

// class property
Object.defineProperty(Collection, 'class', {
	get: function() {
		return Hyperloop.getClass('java.util.Collection');
	},
	enumerable: true,
	configurable: false
});
...
// Cast
Collection.cast = function(object) {
	if (!object.$native || !object.$native.isInstanceProxy) return object;
	return new Collection(Hyperloop.cast('java.util.Collection', object.$native));
};
