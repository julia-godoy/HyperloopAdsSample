...
var _Map = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'java.util.Map') {
		result = arguments[0];
	}
	else {
		var instance = this,
		...
		subclass = Hyperloop.implement('java.util.Map');
...
_Map.isInstanceOf = function (self, cls) {
...
_Map.className = "java.util.Map";
_Map.prototype.className = "java.util.Map";

// class property
Object.defineProperty(_Map, 'class', {
	get: function() {
		return Hyperloop.getClass('java.util.Map');
	},
	enumerable: true,
	configurable: false
});
...
// Cast
_Map.cast = function(object) {
	if (!object.$native || !object.$native.isInstanceProxy) return object;
	return new _Map(Hyperloop.cast('java.util.Map', object.$native));
};

// Constants

_Map.prototype.equals = function (other) {
...
_Map.prototype.hashCode = function () {
	if (!this._hasPointer) return null;
