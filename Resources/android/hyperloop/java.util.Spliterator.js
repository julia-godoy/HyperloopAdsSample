...
var Spliterator = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'java.util.Spliterator') {
		...
		subclass = Hyperloop.implement('java.util.Spliterator');
...
Spliterator.toString = function() {
	return "[object " + this.className + "]";
};

Spliterator.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
Spliterator.isInstanceOf = function (self, cls) {
...
Spliterator.className = "java.util.Spliterator";
Spliterator.prototype.className = "java.util.Spliterator";

// class property
Object.defineProperty(Spliterator, 'class', {
	get: function() {
		return Hyperloop.getClass('java.util.Spliterator');
	},
	enumerable: true,
	configurable: false
});
...
Spliterator.prototype.hashCode = function () {
	if (!this._hasPointer) return null;
