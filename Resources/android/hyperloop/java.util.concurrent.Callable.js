...
var Callable = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'java.util.concurrent.Callable') {
		result = arguments[0];
	}
	else {
		var instance = this,
		...
		subclass = Hyperloop.implement('java.util.concurrent.Callable');
...
Callable.isInstanceOf = function (self, cls) {
...
Callable.className = "java.util.concurrent.Callable";
Callable.prototype.className = "java.util.concurrent.Callable";

// class property
Object.defineProperty(Callable, 'class', {
	get: function() {
		return Hyperloop.getClass('java.util.concurrent.Callable');
	},
	enumerable: true,
	configurable: false
});
...
// Cast
Callable.cast = function(object) {
	if (!object.$native || !object.$native.isInstanceProxy) return object;
	return new Callable(Hyperloop.cast('java.util.concurrent.Callable', object.$native));
};
...
Callable.prototype.hashCode = function () {
	if (!this._hasPointer) return null;
