function initWithOptions(optionsArgument) {
    ...
    var options;
    InLocoMedia = require('hyperloop/com.inlocomedia.android.ads.InLocoMedia');
    InLocoMediaOptions = require('hyperloop/com.inlocomedia.android.ads.InLocoMediaOptions');
    var Activity = require('hyperloop/android.app.Activity');
