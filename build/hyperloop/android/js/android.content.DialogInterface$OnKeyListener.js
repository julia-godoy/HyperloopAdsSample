...
var OnKeyListener = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'android.content.DialogInterface$OnKeyListener') {
		result = arguments[0];
	}
	else {
		var instance = this,
		...
		subclass = Hyperloop.implement('android.content.DialogInterface$OnKeyListener');
...
OnKeyListener.className = "android.content.DialogInterface$OnKeyListener";
OnKeyListener.prototype.className = "android.content.DialogInterface$OnKeyListener";

// class property
Object.defineProperty(OnKeyListener, 'class', {
	get: function() {
		return Hyperloop.getClass('android.content.DialogInterface$OnKeyListener');
	},
	enumerable: true,
	configurable: false
});
...
OnKeyListener.cast = function(object) {
	...
	return new OnKeyListener(Hyperloop.cast('android.content.DialogInterface$OnKeyListener', object.$native));
};
