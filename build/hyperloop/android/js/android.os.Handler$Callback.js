...
var EnclosingClass = require('android.os.Handler');
...
var Callback = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'android.os.Handler$Callback') {
		result = arguments[0];
	}
	else {
		var instance = this,
		...
		subclass = Hyperloop.implement('android.os.Handler$Callback');
...
Callback.className = "android.os.Handler$Callback";
Callback.prototype.className = "android.os.Handler$Callback";

// class property
Object.defineProperty(Callback, 'class', {
	get: function() {
		return Hyperloop.getClass('android.os.Handler$Callback');
	},
	enumerable: true,
	configurable: false
});
...
Callback.cast = function(object) {
	...
	return new Callback(Hyperloop.cast('android.os.Handler$Callback', object.$native));
};
