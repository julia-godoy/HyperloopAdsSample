...
var IdleHandler = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'android.os.MessageQueue$IdleHandler') {
		...
		subclass = Hyperloop.implement('android.os.MessageQueue$IdleHandler');
...
IdleHandler.toString = function() {
	return "[object " + this.className + "]";
};

IdleHandler.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
IdleHandler.isInstanceOf = function (self, cls) {
...
IdleHandler.className = "android.os.MessageQueue$IdleHandler";
IdleHandler.prototype.className = "android.os.MessageQueue$IdleHandler";

// class property
Object.defineProperty(IdleHandler, 'class', {
	get: function() {
		return Hyperloop.getClass('android.os.MessageQueue$IdleHandler');
	},
	enumerable: true,
	configurable: false
});
...
// Cast
IdleHandler.cast = function(object) {
	if (!object.$native || !object.$native.isInstanceProxy) return object;
	return new IdleHandler(Hyperloop.cast('android.os.MessageQueue$IdleHandler', object.$native));
};

// Constants

IdleHandler.prototype.equals = function (other) {
...
IdleHandler.prototype.hashCode = function () {
	if (!this._hasPointer) return null;
