...
var EnclosingClass = require('android.view.InputQueue');
...
var Callback = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'android.view.InputQueue$Callback') {
		result = arguments[0];
	}
	else {
		var instance = this,
		...
		subclass = Hyperloop.implement('android.view.InputQueue$Callback');
...
Callback.className = "android.view.InputQueue$Callback";
Callback.prototype.className = "android.view.InputQueue$Callback";

// class property
Object.defineProperty(Callback, 'class', {
	get: function() {
		return Hyperloop.getClass('android.view.InputQueue$Callback');
	},
	enumerable: true,
	configurable: false
});
...
Callback.cast = function(object) {
	...
	return new Callback(Hyperloop.cast('android.view.InputQueue$Callback', object.$native));
};
