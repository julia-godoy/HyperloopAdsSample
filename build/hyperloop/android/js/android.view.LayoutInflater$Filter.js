...
var Filter = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'android.view.LayoutInflater$Filter') {
		result = arguments[0];
	}
	else {
		var instance = this,
		...
		subclass = Hyperloop.implement('android.view.LayoutInflater$Filter');
...
Filter.className = "android.view.LayoutInflater$Filter";
Filter.prototype.className = "android.view.LayoutInflater$Filter";

// class property
Object.defineProperty(Filter, 'class', {
	get: function() {
		return Hyperloop.getClass('android.view.LayoutInflater$Filter');
	},
	enumerable: true,
	configurable: false
});
...
Filter.cast = function(object) {
	...
	return new Filter(Hyperloop.cast('android.view.LayoutInflater$Filter', object.$native));
};
