...
var EnclosingClass = require('android.view.Window');
...
var Callback = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'android.view.Window$Callback') {
		result = arguments[0];
	}
	else {
		var instance = this,
		...
		subclass = Hyperloop.implement('android.view.Window$Callback');
...
Callback.className = "android.view.Window$Callback";
Callback.prototype.className = "android.view.Window$Callback";

// class property
Object.defineProperty(Callback, 'class', {
	get: function() {
		return Hyperloop.getClass('android.view.Window$Callback');
	},
	enumerable: true,
	configurable: false
});
...
Callback.cast = function(object) {
	...
	return new Callback(Hyperloop.cast('android.view.Window$Callback', object.$native));
};
