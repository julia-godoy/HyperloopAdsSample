...
var SpinnerAdapter = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'android.widget.SpinnerAdapter') {
		...
		subclass = Hyperloop.implement('android.widget.SpinnerAdapter');
...
SpinnerAdapter.toString = function() {
	return "[object " + this.className + "]";
};

SpinnerAdapter.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
SpinnerAdapter.isInstanceOf = function (self, cls) {
...
SpinnerAdapter.className = "android.widget.SpinnerAdapter";
SpinnerAdapter.prototype.className = "android.widget.SpinnerAdapter";

// class property
Object.defineProperty(SpinnerAdapter, 'class', {
	get: function() {
		return Hyperloop.getClass('android.widget.SpinnerAdapter');
	},
	enumerable: true,
	configurable: false
});
...
// Cast
SpinnerAdapter.cast = function(object) {
	if (!object.$native || !object.$native.isInstanceProxy) return object;
	return new SpinnerAdapter(Hyperloop.cast('android.widget.SpinnerAdapter', object.$native));
};

// Constants

SpinnerAdapter.prototype.equals = function (other) {
...
SpinnerAdapter.prototype.hashCode = function () {
	if (!this._hasPointer) return null;
