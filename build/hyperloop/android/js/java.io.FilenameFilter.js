...
var FilenameFilter = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'java.io.FilenameFilter') {
		...
		subclass = Hyperloop.implement('java.io.FilenameFilter');
...
FilenameFilter.toString = function() {
	return "[object " + this.className + "]";
};

FilenameFilter.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
FilenameFilter.isInstanceOf = function (self, cls) {
...
FilenameFilter.className = "java.io.FilenameFilter";
FilenameFilter.prototype.className = "java.io.FilenameFilter";

// class property
Object.defineProperty(FilenameFilter, 'class', {
	get: function() {
		return Hyperloop.getClass('java.io.FilenameFilter');
	},
	enumerable: true,
	configurable: false
});
...
// Cast
FilenameFilter.cast = function(object) {
	if (!object.$native || !object.$native.isInstanceProxy) return object;
	return new FilenameFilter(Hyperloop.cast('java.io.FilenameFilter', object.$native));
};

// Constants

FilenameFilter.prototype.equals = function (other) {
...
FilenameFilter.prototype.hashCode = function () {
	if (!this._hasPointer) return null;
