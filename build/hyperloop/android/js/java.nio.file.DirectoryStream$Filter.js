...
var EnclosingClass = require('java.nio.file.DirectoryStream');

/**
 * constructor
 * http://developer.android.com/reference/java/nio/file/DirectoryStream.Filter.html
 **/
var Filter = function() {
	var result;
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'java.nio.file.DirectoryStream$Filter') {
		...
		subclass = Hyperloop.implement('java.nio.file.DirectoryStream$Filter');
...
Filter.isInstanceOf = function (self, cls) {
...
Filter.className = "java.nio.file.DirectoryStream$Filter";
Filter.prototype.className = "java.nio.file.DirectoryStream$Filter";

// class property
Object.defineProperty(Filter, 'class', {
	get: function() {
		return Hyperloop.getClass('java.nio.file.DirectoryStream$Filter');
	},
	enumerable: true,
	configurable: false
});
...
// Cast
Filter.cast = function(object) {
	if (!object.$native || !object.$native.isInstanceProxy) return object;
	return new Filter(Hyperloop.cast('java.nio.file.DirectoryStream$Filter', object.$native));
};
