...
var Enumeration = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'java.util.Enumeration') {
		result = arguments[0];
	}
	else {
		var instance = this,
		...
		subclass = Hyperloop.implement('java.util.Enumeration');
...
Enumeration.isInstanceOf = function (self, cls) {
...
Enumeration.className = "java.util.Enumeration";
Enumeration.prototype.className = "java.util.Enumeration";

// class property
Object.defineProperty(Enumeration, 'class', {
	get: function() {
		return Hyperloop.getClass('java.util.Enumeration');
	},
	enumerable: true,
	configurable: false
});
...
// Cast
Enumeration.cast = function(object) {
	if (!object.$native || !object.$native.isInstanceProxy) return object;
	return new Enumeration(Hyperloop.cast('java.util.Enumeration', object.$native));
};
...
Enumeration.prototype.hashCode = function () {
	if (!this._hasPointer) return null;
