...
var SortedMap = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'java.util.SortedMap') {
		...
		subclass = Hyperloop.implement('java.util.SortedMap');
...
SortedMap.isInstanceOf = function (self, cls) {
...
SortedMap.className = "java.util.SortedMap";
SortedMap.prototype.className = "java.util.SortedMap";

// class property
Object.defineProperty(SortedMap, 'class', {
	get: function() {
		return Hyperloop.getClass('java.util.SortedMap');
	},
	enumerable: true,
	configurable: false
});
...
// Cast
SortedMap.cast = function(object) {
	if (!object.$native || !object.$native.isInstanceProxy) return object;
	return new SortedMap(Hyperloop.cast('java.util.SortedMap', object.$native));
};

// Constants

SortedMap.prototype.equals = function (other) {
...
SortedMap.prototype.hashCode = function () {
	if (!this._hasPointer) return null;
