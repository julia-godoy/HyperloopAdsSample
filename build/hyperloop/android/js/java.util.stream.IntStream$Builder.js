...
var EnclosingClass = require('java.util.stream.IntStream');

/**
 * constructor
 * http://developer.android.com/reference/java/util/stream/IntStream.Builder.html
 **/
var Builder = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'java.util.stream.IntStream$Builder') {
		...
		subclass = Hyperloop.implement('java.util.stream.IntStream$Builder');
...
Builder.className = "java.util.stream.IntStream$Builder";
Builder.prototype.className = "java.util.stream.IntStream$Builder";

// class property
Object.defineProperty(Builder, 'class', {
	get: function() {
		return Hyperloop.getClass('java.util.stream.IntStream$Builder');
	},
	enumerable: true,
	configurable: false
});
...
Builder.cast = function(object) {
	...
	return new Builder(Hyperloop.cast('java.util.stream.IntStream$Builder', object.$native));
};
