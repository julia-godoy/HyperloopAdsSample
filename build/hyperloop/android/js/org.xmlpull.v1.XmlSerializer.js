...
var XmlSerializer = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'org.xmlpull.v1.XmlSerializer') {
		...
		subclass = Hyperloop.implement('org.xmlpull.v1.XmlSerializer');
...
XmlSerializer.toString = function() {
...
XmlSerializer.isInstanceOf = function (self, cls) {
...
XmlSerializer.className = "org.xmlpull.v1.XmlSerializer";
XmlSerializer.prototype.className = "org.xmlpull.v1.XmlSerializer";

// class property
Object.defineProperty(XmlSerializer, 'class', {
	get: function() {
		return Hyperloop.getClass('org.xmlpull.v1.XmlSerializer');
	},
	enumerable: true,
	configurable: false
});
...
// Cast
XmlSerializer.cast = function(object) {
	if (!object.$native || !object.$native.isInstanceProxy) return object;
	return new XmlSerializer(Hyperloop.cast('org.xmlpull.v1.XmlSerializer', object.$native));
};

// Constants

XmlSerializer.prototype.equals = function (other) {
...
XmlSerializer.prototype.hashCode = function () {
	if (!this._hasPointer) return null;
